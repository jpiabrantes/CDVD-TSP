...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../dataset/realsense',
    ...
    parser.add_argument('--result_path', type=str, default='../infer_results/realsense',
                        help='the path of deblur result')
    args = parser.parse_args()

    if args.default_data == 'DVD':
        args.data_path = '../dataset/realsense'
        args.model_path = '../pretrain_models/CDVD_TSP_DVD_Convergent.pt'
        args.result_path = '../infer_results/realsense'
